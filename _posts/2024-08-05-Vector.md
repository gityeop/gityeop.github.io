...
<br> 2. 각 벡터의 L2 노름을 계산합니다.

\|\mathbf{a}\|2 = \sqrt{\sum{i=1}^{n} a_i^2}, \quad \|\mathbf{b}\|2 = \sqrt{\sum{i=1}^{n} b_i^2}
<br> 3. 내적을 두 벡터의 L2 노름의 곱으로 나눕니다.

\cos \theta = \frac{\mathbf{a} \cdot \mathbf{b}}{\|\mathbf{a}\|\_2 \|\mathbf{b}\|\_2}
<br> 4. 마지막으로, 아크코사인(\arccos) 함수를 사용해 각도 \theta를 구합니다.
